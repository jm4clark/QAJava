...
public class Application {
	public static void main(String[] args) {
		...
		Car car1 = new Car("red", 80, 12000, false, false);
		Motorbike bike1 = new Motorbike("black", 90, 18000, true);
		Car car2= new Car("blue", 100, 20000, true, false);
		...
		System.out.println(garage.fixVehicle(3));
